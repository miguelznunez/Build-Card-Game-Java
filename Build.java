...
public class Build
{
    ...
    static JLabel[] scores = new JLabel[3];
   ...
   static void addPlayer2Events(CardGameFramework lcg, CardTable ct)
   {
    for (int k = 0; k < NUM_CARDS_PER_HAND; k++)
    {
      final int index = k;
   ...
   static void addPlayer1Events(CardGameFramework lcg, CardTable ct)
   {
    for (int k = 0; k < NUM_CARDS_PER_HAND; k++)
    {
      final int index = k;
    ...
    static void addCannotPlayBtn(CardGameFramework lcg, CardTable ct)
     {
      ...
      icpBtn.setBorder(BorderFactory.createCompoundBorder(
               ...
               BorderFactory.createLineBorder(Color.decode("#47d147"), 17)));
   ...
   public static void main(String[] args)
   {
     ...
     CardTable myCardTable 
         = new CardTable("Build Game by Miguel Nunez", NUM_CARDS_PER_HAND, NUM_PLAYERS);
     ...
     // add event listeners
     addPlayer1Events(LowCardGame, myCardTable); 
     addPlayer2Events(LowCardGame, myCardTable);     
...
class CardTable extends JFrame 
{
   ...
   public CardTable(String title, int numCardsPerHand, int numPlayers) 
   {
         ...
         if((numCardsPerHand <= MAX_CARDS_PER_HAND) && (numPlayers <= MAX_PLAYERS))
         {
             ...
             pnlScore.setBackground(Color.decode("#47d147"));
             c.gridx = 0;
             c.gridy = 0;
             add(pnlScore, c);
             ...
             pnlComputerHand.setBackground(Color.decode("#47d147"));
             pnlComputerHand.setBorder(BorderFactory.createTitledBorder(
             BorderFactory.createEtchedBorder(Color.decode("#47d147"), Color.decode("#47d147")), "Player 1 Hand", TitledBorder.LEFT, TitledBorder.TOP));
             c.gridx = 0;
             c.gridy = 1;
             ...
             for(int i  = 0;i < 3;i++)
             {
              ...
              paneHolder[i].setBackground(Color.decode("#47d147"));
             ...
             pnlHumanHand.setBackground(Color.decode("#47d147"));
             pnlHumanHand.setBorder(BorderFactory.createTitledBorder(
             BorderFactory.createEtchedBorder(Color.decode("#47d147"), Color.decode("#47d147")), "Player 2 Hand", TitledBorder.LEFT, TitledBorder.TOP));            
             c.gridx = 0;
             c.gridy = 3;
             add(pnlHumanHand, c);
             ...
             pnlTimer = new JPanel();
             pnlTimer.setBackground(Color.decode("#47d147"));
             c.gridx = 0;
             c.gridy = 4;
             add(pnlTimer, c);
...
class Timer extends Thread 
{
  ...
  public Timer() 
  {
    ...
    panel.setBackground(Color.decode("#47d147"));
